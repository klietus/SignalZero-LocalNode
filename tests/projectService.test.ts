...
describe('ProjectService', () => {
    beforeEach(() => {
        ...
        vi.mocked(domainService.updateDomainMetadata).mockResolvedValue({ id: 'd1', symbols: [] } as any);
        ...
        vi.mocked(agentService.replaceAllAgents).mockResolvedValue(undefined);
    ...
    it('should import project from zip buffer', async () => {
        ...
        expect(agentService.replaceAllAgents).toHaveBeenCalledWith(expect.any(Array));
    });
});
